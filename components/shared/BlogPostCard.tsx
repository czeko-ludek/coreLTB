...
export function BlogPostCard({
  ...
  return (
    <Link
      ...
      className="group block bg-surface-light rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-xl"
    >
      {/* Image section */}
      ...
      <div className="p-6 space-y-4">
        ...
        <span className="inline-flex items-center gap-2 text-text-primary font-medium group-hover:text-primary transition-colors">
          Czytaj Więcej
