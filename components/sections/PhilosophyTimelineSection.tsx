...
export function PhilosophyTimelineSection({ header, items, image }: PhilosophyTimelineSectionProps) {
  ...
  return (
    <section ref={ref} className="py-10 md:py-20 px-0 md:px-4 lg:px-[50px] bg-white">
      <div className="md:container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 md:gap-12 items-stretch">
          ...
          <div className={`relative h-full min-h-[250px] md:min-h-[400px] rounded-2xl md:rounded-xl overflow-hidden shadow-none md:shadow-2xl md:ring-1 md:ring-black/5 animate-curtain-reveal ${inView ? 'curtain-animate' : ''}`}>
            <Image
              src={image.src}
              alt={image.alt}
              fill
          ...
          {/* Prawa strona: Twoja lista elementów */}
