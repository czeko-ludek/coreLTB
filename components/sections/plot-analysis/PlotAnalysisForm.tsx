        ...
        <div className="bg-background-light">
          ...
          >
            ...
            <div className="px-6 py-5 mt-auto border-t border-gray-100">
              ...
              <a href="tel:+48664123757" onClick={() => trackPhoneClick('plot-analysis-mobile-menu')} className="flex items-center gap-3 py-2.5 text-base font-medium text-gray-700">
              ...
              <div className="max-w-md w-full">
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-3">
                  <a
                    ...
                    onClick={() => trackPhoneClick('plot-analysis-success')}
          ...
          >
            ...
            <div className="mt-8 border-t border-border-light pt-6">
              <a
                href="tel:+48664123757"
                onClick={() => trackPhoneClick('plot-analysis-form')}
