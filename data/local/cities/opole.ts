        ...
        content: [
          {
            type: 'paragraph',
            value:
              'Stawki wg naszego [kalkulatora](/wycena): SSO **3 000–4 000 zł/m²**, [stan deweloperski](/oferta/kompleksowa-budowa-domow) **3 960–5 520 zł/m²**, pod klucz **4 640–6 200 zł/m²** netto (zależnie od konfiguracji). W rejonach nadodrzańskich dolicz **8–15 tys. zł** na hydroizolację ciężką i drenaż opaskowy. Na gruntach z warstwami organicznymi koszt fundamentu może wzrosnąć o **15–20%**.',
          },
        ],
      },
      {
