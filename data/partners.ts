...
export const partners: Partner[] = [
  ...
  {
    slug: 'optima',
    name: 'Optima Nieruchomości i Finanse',
    logo: '/images/partners/optima.webp',
    logoScale: 2.5,
    category: 'nieruchomosci',
    shortDescription:
      'Biuro nieruchomości i doradztwo finansowe — Knurów i Górny Śląsk.',
    description: [
      'Optima Nieruchomości i Finanse to biuro z Knurowa działające na terenie Górnego Śląska, specjalizujące się w kompleksowej obsłudze transakcji na rynku nieruchomości. Firma obsługuje głównie rejon Gliwic, Zabrza i okolicznych miejscowości.',
      'Dodatkowym atutem Optima jest doradztwo finansowe — firma pomaga klientom uzyskać korzystny kredyt hipoteczny lub konsumencki. Indywidualne podejście, bezpieczeństwo transakcji i profesjonalne wsparcie na każdym etapie procesu to filary działania biura.',
    ],
    services: [
    ...
    location: 'Knurów (Górny Śląsk)',
    website: 'https://mfoptima.pl',
    featured: true,
  },
];
