# Google Ads — Kampania PMax: CoreLTB Budowa Domow

> **Status:** AKTYWNA — w fazie nauki
> **Data startu:** 2026-03-24
> **Konto Google Ads:** 374-981-3686 (dawidrduchtarget@gmail.com)
> **GA4:** G-SMNG7006SN (polaczone z Ads, konwersje importowane)
> **GTM:** GTM-TPFV68BN
...
| Baza | Centrum | Promien |
|---|---|---|
| Jaworzno | Jaworzno | 35 mil (~56 km) |
| Wodzislaw Sl. | Wodzislaw Slaski | 25 mil (~40 km) |

Opcja lokalizacji: Obecnosc (osoby w lokalizacji)

### Wizytowki GBP podpiete

- CoreLTB Builders — Jaworzno (Grunwaldzka 34a, 43-600)
- CoreLTB Builders — Wodzislaw Sl.
- ~~Elb Projekt Barbara~~ — wykluczona

---

## Konwersje (GA4 → Google Ads)

| Konwersja | Kategoria | Optymalizacja | Wartosc (docelowa) | Stan |
|---|---|---|---|---|
| calculator_lead | Przeslanie formularza | Podstawowe (Primary) | 150 zl | Czeka na sync |
| consultation_lead | Przeslanie formularza | Podstawowe (Primary) | 100 zl | Czeka na sync |
| plot_analysis_lead | Przeslanie formularza | Podstawowe (Primary) | 80 zl | Czeka na sync |
| phone_click | — | — | 50 zl | Nie podpiety w kodzie |

> Wartosci konwersji do ustawienia w Google Ads po aktywacji (sync GA4 → Ads do 24h od 2026-03-24)

---

## Asset Group 1: Budowa domow — Rybnik, Wodzislaw, Jaworzno i okolice

### Naglowki (15 szt., max 30 znakow)

| # | Naglowek | Typ |
|---|---|---|
| 1 | Budowa Domow — Slask | Geo |
| 2 | Budowa Domow Pod Klucz | Usluga |
| 3 | Oblicz Koszt w 60 Sekund | CTA/Kalkulator |
| 4 | Kalkulator Budowy Online | CTA/Kalkulator |
| 5 | Stala Cena w Umowie | USP |
| 6 | Domy SSO i Pod Klucz | Usluga |
| 7 | 10 Lat Gwarancji | USP |
| 8 | Budowa Domow — Rybnik | Geo |
| 9 | Budowa Domow — Jaworzno | Geo |
| 10 | Ile Kosztuje Budowa Domu? | CTA/Kalkulator |
| 11 | 200+ Zrealizowanych Domow | Social proof |
| 12 | Firma Budowlana — Slask | Geo |
| 13 | Poznaj Cene Budowy Domu | CTA/Kalkulator |
| 14 | Budowa Domow — Wodzislaw | Geo |
| 15 | Budowa Domow — Gliwice | Geo |

### Dlugie naglowki (5 szt., max 90 znakow)

| # | Dlugi naglowek | Zn. |
|---|---|---|
| 1 | Oblicz koszt budowy domu w 60 sekund — darmowy kalkulator online | 64 |
| 2 | Budowa domow w Rybniku, Wodzislawiu i Jaworzno — stala cena w umowie | 69 |
| 3 | Ile kosztuje budowa domu? Sprawdz SSO, deweloperski i pod klucz | 62 |
| 4 | Firma budowlana z 200+ realizacjami — od fundamentu po odbior kluczy | 68 |
| 5 | Budujemy domy na Slasku — Rybnik, Wodzislaw, Jaworzno. 10 lat gwarancji | 72 |

### Teksty reklam (5 szt., max 90 znakow)

| # | Tekst reklamy | Zn. |
|---|---|---|
| 1 | Kalkulator budowy domu — poznaj koszt SSO, deweloperski i pod klucz w 60 sekund. | 82 |
| 2 | Budowa domow w Rybniku, Wodzislawiu i Jaworzno. Od fundamentu po klucz. 10 lat gwarancji. | 90 |
| 3 | 200+ domow. Dwie bazy: Jaworzno i Wodzislaw Sl. Rybnik, Gliwice, Zory, Tychy i okolice. | 89 |
| 4 | Ile kosztuje budowa domu w 2026? Skonfiguruj dom i poznaj kosztorys. Bez zobowiazan. | 85 |
| 5 | Bezplatna analiza dzialki i konsultacja z inzynierem. Dobierzemy technologie do budzetu. | 89 |

### Sitelinki (6 szt.)

| Tekst | URL | Linia 1 | Linia 2 |
|---|---|---|---|
| Kalkulator budowy | /wycena | Oblicz koszt domu w 60 sekund | SSO, deweloperski i pod klucz |
| Projekty domow | /projekty | 250+ projektow z kalkulacja | Parterowe, pietrowe, z poddaszem |
| Umow konsultacje | /umow-konsultacje | Bezplatna rozmowa z inzynierem | Oddzwonimy w ciagu 24 godzin |
| Analiza dzialki | /analiza-dzialki | Sprawdzimy warunki Twojej dzialki | Grunt, MPZP, uzbrojenie mediow |
| Budowa domow — oferta | /oferta/kompleksowa-budowa-domow | SSO, deweloperski, pod klucz | Stala cena w umowie, 10 lat gwar. |
| Obszar dzialania | /obszar-dzialania | Rybnik, Jaworzno, Gliwice, Zory | Wodzislaw, Tychy, Katowice i okolice |

### Rozszerzenia dodatkowe

**Objasnienias (Callouts, 6 szt.):**
1. Stala cena w umowie
2. 10 lat gwarancji
3. 200+ realizacji
4. Dwie bazy na Slasku
5. Darmowy kalkulator online
6. Bezplatna analiza dzialki

**Rozszerzenia informacji (Structured Snippets):**
- Typ: Uslugi
- Wartosci: SSO, Stan deweloperski, Pod klucz, Nadzor budowy, Projektowanie

**Polaczenie telefoniczne:**
- +48 664 123 757

**Sciezka wyswietlania:**
- www.coreltb.pl / wycena / budowa

### Obrazy (20 szt.)

- Fotorealistyczne wizualizacje projektow domow (landscape + kwadrat)
- Zdjecia z realizacji budow
- Logo kwadratowe

### Wideo

Brak — Google AI generuje automatycznie z obrazow

---

## Search Themes (10 szt.)

| # | Search Theme | Zrodlo danych |
|---|---|---|
| 1 | budowa domow rybnik | GSC: 78 imp |
| 2 | budowa domow wodzislaw slaski | GSC: 66 imp |
| 3 | firma budowlana jaworzno | GBP: 89 szukan |
| 4 | budowa domu jaworzno | GSC: 19 imp |
| 5 | ile kosztuje budowa domu | DataForSEO: CPC 0.48 zl |
| 6 | kalkulator budowy domu | DataForSEO: CPC 0.53 zl |
| 7 | budowa domow zory | GSC: 20 imp |
| 8 | budowa domu gliwice | GSC: 19 imp |
| 9 | dom pod klucz slask | GSC: 21 imp |
| 10 | firma budowlana slask | DataForSEO: CPC 1.43 zl |

---

## Negative Keywords (lista: CoreLTB — Wykluczenia globalne)

Zastosowana do kampanii. Dopasowanie przyblizzone.

**Praca:**
praca, oferty pracy, zatrudnienie, dam prace, pracownik, murarz praca, operator koparki

**Edukacja:**
kurs, szkolenie, studia, technikum, zawodowe

**Poza zasiegiem:**
warszawa, gdansk, poznan, wroclaw, lodz, szczecin, lublin, bialystok

**Nie nasza technologia:**
szkieletowy, modulowy, prefabrykowany, kontenerowy, drewniany

**Deweloper/mieszkanie:**
deweloper, mieszkanie, blok, kawalerka, apartament, wynajem

**Remont:**
remont, odnawianie, renowacja, malowanie

**False positives kalkulator:**
excel, arkusz, szablon, pobierz, pdf, darmowy kalkulator

**Sprzedaz dzialek:**
dzialka na sprzedaz, kupno dzialki, dzialki budowlane sprzedaz

---

## Optymalizacja komponentow
...
## Tagi analityczne — stan

| Element | Status | Uwagi |
|---|---|---|
| GTM Container | Aktywny | GTM-TPFV68BN w app/layout.tsx |
| GA4 Config | Aktywny | G-SMNG7006SN przez GTM |
| Consent Mode v2 | Aktywny | Defaults denied, update na akceptacje |
| GA4 tag calculator_lead | Aktywny | Trigger: dataLayer event |
...
## Faza nauki — harmonogram

### Tydzien 1-2 (2026-03-24 → 2026-04-07): NIE RUSZAC

- [x] Kampania opublikowana
- [ ] Konwersje zsynchronizowane GA4 → Ads (sprawdzic 2026-03-25)
- [ ] Ustawic wartosci konwersji w Ads (150/100/80 zl) po aktywacji
- [ ] Codziennie: sprawdzac czy sa wyswietlenia/klikniecia
- [ ] Co tydzien: Insights → Search term insights → nowe negative keywords
- [ ] Co tydzien: Insights → Placement report → wykluczenia

### Tydzien 3-4: Pierwsza optymalizacja

- [ ] Raport assetow — usunac assety z ocena "Low"
- [ ] Placement report — wykluczyc gry mobilne, apki
- [ ] Search terms — dodac negative keywords
- [ ] Ocenic CPA — cel < 50 zl
- [ ] Sprawdzic landing pages — czy /wycena konwertuje najlepiej

### Miesiac 2: Skalowanie

- [ ] Jesli CPA < 50 zl — rozwazyc zwiekszenie budzetu do 75-100 zl/dzien
