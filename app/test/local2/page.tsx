/**
 * Layout B: "Minimalny konwerter" — DEPRECATED
...
export const metadata: Metadata = {
  title: '[TEST B] Layout B — Minimalny konwerter',
  robots: 'noindex, nofollow',
};

export default function TestLocal2Page() {
  return (
    <main className="min-h-screen flex items-center justify-center bg-zinc-50">
      <div className="text-center space-y-4">
        <h1 className="text-2xl font-bold text-zinc-900">Layout B — Odrzucony</h1>
