...
// ── Static data ──
const SLUG = 'kierownik-budowy-katowice';
...
// ── Page Component ──
export default function KierownikBudowyKatowicePage() {
  ...
  return (
    <>
      <main>
        ...
        {/* 4. WhyUsSection — 4 karty usług (Budowa, Rozbudowa, Dziennik, Koordynacja) */}
        <WhyUsSection
        ...
        {/* 5. LocalExpertiseSection — szkody górnicze + PINB */}
        ...
        <ContactCTASection
          ...
          primaryButton={{ text: 'Umów Nadzór', href: '/umow-konsultacje?usluga=nadzor&miasto=katowice' }}
        />
      </main>
